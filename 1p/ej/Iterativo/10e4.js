console.log("Generar 10e4 numeros aleatorios");
...
for (i=0; i<=9999; i++) 
{
    array4.push(Math.round(Math.random() * 10000));
}
...
console.log(insercion(array4));

console.log("¿Cuántas inversiones requiere cada uno en promedio? 9999");
